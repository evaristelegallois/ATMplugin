...
bool EnvelopeExtractor::ExtractConcaveHull2D(std::vector<Vertex2D>& points,
...
ccPolyline* EnvelopeExtractor::ExtractFlatEnvelope(CCCoreLib::GenericIndexedCloudPersist* points,
	bool allowMultiPass,
...
bool EnvelopeExtractor::ExtractFlatEnvelope(CCCoreLib::GenericIndexedCloudPersist* points,
	bool allowMultiPass,
